...
class gcForest(object):
    ...
    def __init__(self, shape_1X=None, n_mgsRFtree=220, window=None, stride=3,
        ...
        :param min_samples_mgs: float or int (default=0.1)
            ...
            节点中执行拆分的最小样本数 在多粒度扫描随机森林训练期间。
            如果int number_of_samples = int。 如果float，min_samples表示要考虑的初始n_samples的分数。
    ...
    def mg_scanning(self, X, y=None):
        ...
        shape_1X = getattr(self, 'shape_1X')  # (9,9)
